...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    /*如果到了这里，说明光线与三角形相交，下面改写inter相交的信息*/
    inter.happened = true;//成功相交
    inter.coords = ray(t_tmp);//通过O+t*D获得 光线与物体相交的点
    inter.normal = normal;//获得当前obj的法线
    inter.distance = t_tmp;//光线传输时间正比于距离
    inter.m = m;//获得三角形材质
    inter.obj = this;//相交信息指向当前三角形
    return inter;
}
